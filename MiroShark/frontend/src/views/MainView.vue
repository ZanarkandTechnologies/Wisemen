  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MIRO SUPPLY</div>
      </div>
...
// Step State
const currentStep = ref(1) // 1: Graph Construction, 2: Stakeholder Setup, 3: Cascade Run, 4: Risk Brief, 5: Agent Interrogation
const stepNames = ['Graph Construction', 'Stakeholder Setup', 'Cascade Run', 'Risk Brief', 'Agent Interrogation']
