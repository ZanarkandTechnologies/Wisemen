  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="tag-row">
          <span class="orange-tag">Operational Supply-Chain Risk Simulator</span>
        </div>

        <h1 class="main-title">
          <span class="gradient-text">Simulate Factory Shock Cascades</span>
        </h1>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Risk engine on standby. Upload factory inputs to initialize the shock simulation workflow.
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Scenario ingestion, supply graph extraction, and operational context grounding</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Generate factory stakeholders and configure the operational response environment</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">03</span>
                <div class="step-info">
                  <div class="step-title">Cascade Run</div>
                  <div class="step-desc">Run the shock scenario and watch risk signals propagate across the operating network</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">04</span>
                <div class="step-info">
                  <div class="step-title">Risk Brief</div>
                  <div class="step-desc">Generate the operational brief with failure chain, disruption window, and mitigations</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">05</span>
                <div class="step-info">
                  <div class="step-title">Agent Interrogation</div>
                  <div class="step-desc">Question the risk analyst or a stakeholder to understand the same shock-driven outcome</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="right-panel">
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">>_ 02 / Risk Scenario Prompt</span>
              </div>
              <div class="input-wrapper">
                <textarea
                  v-model="formData.simulationRequirement"
                  class="code-input"
                  placeholder="// Enter the supply-chain shock in natural language (e.g., China restricts lithium precursor exports for 30 days. Show the failure chain, disruption window, and best mitigation actions.)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
            ...
            <div class="console-section btn-section">
              ...
              >
                <span v-if="!loading">Launch Risk Simulation</span>
