    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Combines context to organize the supply graph, initialize simulated stakeholders, and assign operating behaviors and memories grounded in the uploaded scenario
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
                ...
                >
                  ...
                  <div class="agent-params">
                    ...
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Risk Bias</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
            <span class="config-block-title">Operational Response Lane Configuration</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Plant Floor</span>
                  </div>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Supplier Desk</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Timeliness Weight</span>
                ...
                <div class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Risk Market</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                    ...
                    <div class="param-row">
                      <span class="param-label">Risk Signal Bridge</span>
                      <span class="param-value">Enabled (market stress feeds operating signals)</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">Miro Supply automatically plans to simulate <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of operational reality, each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
          ...
          <div class="action-group dual">
            ...
            >
              {{ hasRunBefore ? 'Resume Cascade Run ➝' : 'Start Cascade Run ➝' }}
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section">
              <span class="section-label">Stakeholder Summary</span>
          ...
          <!-- Detailed Stakeholder Background -->
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">Detailed Stakeholder Background</span>
            
            <!-- Stakeholder Context Overview -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Full Shock Context</span>
                <span class="dim-desc">Complete operating context for this simulated stakeholder</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                <span class="dim-title">Operating Relationship Network</span>
                <span class="dim-desc">Supplier, plant, and market connections influencing this stakeholder</span>
              </div>
            </div>
...
const normalizeUiText = (text = '') => {
  return text
    .replaceAll('Generating Agent Personas', 'Generating Stakeholder Profiles')
    .replaceAll('agent personas', 'stakeholder profiles')
    .replaceAll('agent persona', 'stakeholder profile')
    .replaceAll('Agent Setup', 'Stakeholder Setup')
}
...
// Calculate total related topics across all stakeholder profiles
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      progressMessage.value = normalizeUiText(data.message || '')
      
      // Parse stage info and output detailed logs
      if (data.progress_detail) {
        currentStage.value = normalizeUiText(data.progress_detail.current_stage_name || '')
        ...
        if (logKey !== lastLoggedMessage && detail.item_description) {
          ...
          const stageName = normalizeUiText(detail.current_stage_name || '')
          const itemDescription = normalizeUiText(detail.item_description || '')
          if (detail.total_items > 0) {
            addLog(`${stageInfo} ${stageName}: ${detail.current_item}/${detail.total_items} - ${itemDescription}`)
          } else {
            addLog(`${stageInfo} ${stageName}: ${itemDescription}`)
          }
        }
        ...
        if (match) {
          currentStage.value = normalizeUiText(match[3].trim())
        }
        // Output message log (avoid duplicates)
        if (data.message !== lastLoggedMessage) {
          lastLoggedMessage = data.message
          addLog(normalizeUiText(data.message))
        }
      }
    ...
    if (res.success && res.data) {
      ...
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        ...
        if (data.generation_stage === 'generating_profiles') {
          addLog('Generating stakeholder profile configuration...')
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  └─ Signal lanes: Plant Floor ${data.summary.has_twitter_config ? '✓' : '✗'}, Supplier Desk ${data.summary.has_reddit_config ? '✓' : '✗'}`)
        }
