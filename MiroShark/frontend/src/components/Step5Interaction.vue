    ...
    <div class="main-split-layout">
      ...
      <div class="left-panel report-style" ref="leftPanel">
        <div v-if="reportOutline" class="report-content-wrapper">
          ...
          <div class="report-header-block">
            <div class="report-meta">
              <span class="report-tag">Operational Risk Brief</span>
        ...
        <div v-if="!reportOutline" class="waiting-placeholder">
          ...
          <span class="waiting-text">Loading operational risk brief...</span>
        </div>
      </div>
      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            ...
            <span class="action-bar-subtitle mono">{{ profiles.length }} stakeholders available</span>
          </div>
        </div>
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Chat with Risk Analyst</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Stakeholder Chat' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">Risk Analyst - Chat</div>
                <div class="tools-card-subtitle">Quick chat version of the operational brief analyst with access to the same simulation evidence and graph context.</div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the risk analyst to inspect the operational brief' : 'Chat with simulated stakeholders to understand the same shock from their point of view' }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? 'You' : (chatTarget === 'report_agent' ? 'Risk Analyst' : (selectedAgent?.username || 'Agent')) }}
                  </span>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header section-header-toggle" @click="showPersonaSection = !showPersonaSection">
                <div class="section-header-left">
                  ...
                  <span class="section-title">Select Stakeholder</span>
                </div>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Stakeholder Question</span>
              </div>
              <textarea 
        ...
        <div class="profile-popup">
          ...
          <div class="profile-popup-details">
            ...
            <div class="profile-popup-row" v-if="profilePopupAgent.persona">
              <span class="popup-label" @click="showFullPersona = !showFullPersona" style="cursor:pointer">Operating Context {{ showFullPersona ? '▼' : '▶' }}</span>
...
const sendToReportAgent = async (message) => {
  addLog(`Sending to Risk Analyst: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Risk Analyst has replied')
  } else {
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Loaded ${profiles.value.length} simulated stakeholders`)
    }
  } catch (err) {
    addLog(`Failed to load simulated stakeholders: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Step 5 Agent Interrogation initializing')
  loadReportData()
  loadProfiles()
